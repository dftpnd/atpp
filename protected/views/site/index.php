<!--<pre>
<?php //var_dump($slides[0]->attributes);die();?>
</pre>-->
...
<div class="page-header">
    ...
    <div class="world_info">Здесь находится сообщество людей, которым не безралична жизнь кафедры</div>
</div>
        ...
        <div class="slide_box">
            ...
            <?php foreach ($slides as $slide): ?>
                ...
                <div class="slide" slide="<?php echo $active_class; ?>" >
                    ...
                    <?php $left_slide = '0'; ?>
                    <?php $top_slide = '0'; ?>
                    <?php if (empty($slide->left_slide)) $left_slide = '0';else $left_slide = $slide->left_slide; ?>
                    <?php if (empty($slide->top_slide)) $top_slide = '0'; else $top_slide = $slide->top_slide; ?>
...
<script>
    ...
    BuildSlider();
    setInterval("LiftSlide(1,1)",20000);
...
<div class="page-header">
    ...
    <div class="reg_tut">
        <span>&rarr;&nbsp;</span><a href="<?php echo Yii::app()->createAbsoluteUrl('/site/registration'); ?>" class="classic">регистрация тут</a>
    </div>
</div>
    ...
    <div class="wants">
        <div class="table_t">
            <div class="tr_t">
                <div class="td_t">
                    <h2>Новости</h2>
                    <a href="<?php echo Yii::app()->request->baseUrl; ?>/post/index" class="wants_rot aspx_4 active_poplavok" space="1" >
                ...
                <div class="td_t">
                    <h2>Cтатистика</h2>
                    <a href="<?php echo Yii::app()->request->baseUrl; ?>/reestr/index" class="wants_rot aspx_5" space="4">
                ...
                <div class="td_t">
                    <h2>Вопросы</h2>
                    <a href="<?php echo Yii::app()->request->baseUrl; ?>/forum/index" class="wants_rot aspx_7" space="2" >
                ...
                <div class="td_t">
                    <h2>Коммуникация</h2>
                    <a href="<?php echo Yii::app()->request->baseUrl; ?>/library/index" class="wants_rot aspx_9" space="3" >
...
<script>
    ...
    function SelectText(id_text){
        if(id_text == '1'){
            text = 'Сдесь вы можете, не только читайть интересные и свежие новости, но и сами учавствовать в их публикации.';
        }else if(id_text == '2'){
            text = 'Здесь вы можете задать вопрос преподавателю. ';
        }else if(id_text == '3'){
            text = 'Здесь вы можете, найти полезный материал и поделится им с другими.';
        }else if(id_text == '4'){
            text = 'Теперь расписание всегда под рукой. Кажется, вы уже лучше учитесь!';
        }
        return text;
    }
    $('.wants_text_in').text(text);
...
<!--<div class="page-header">
  <h1>Открой кафедру заново</h1>
</div>-->
<!--<div class="obnovleniy">
  <ul>
    <li>
      - разработка сайта
    </li>
    <li>
      - научаная работа с сименс
    </li>
    <li>
      - научная работа нано течь
    </li>
    <li>
      - открой свое направление
    </li>
  </ul>
