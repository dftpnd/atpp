...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.iosslider.min.js"></script>


<script>
  $(function() {
  
    $('.short-width-slider-1').iosSlider({
      desktopClickDrag: true,
      snapToChildren: true,
      infiniteSlider: true,
      navNextSelector: '.useful_resources .next',
      navPrevSelector: '.useful_resources .prev'
    });
  });
</script>
<div class="rectifier">
  <div class="short-width-slider-1" >
    <div class="slider">
      <div id="" class="item slides-picter" style="">
        <a href="#" class="slides_d" >
          <div style="background: green"></div>
        </a>
      </div>
      <div  class="item slides-picter">
        <a href="#" class="slides_d" >
      ...
      <div  class="item slides-picter">
        <a href="#" class="slides_d" >
          <div style="background: peachpuff"></div>
        </a>
      </div>
      <div  class="item slides-picter">
        <a href="#" class="slides_d" >
      ...
      <div  class="item slides-picter">
        <a href="#" class="slides_d" >
          <div style="background: powderblue" ></div>
        </a>
      </div>
    </div>
  </div>
  <div class="slides_d_prev" style="cursor: pointer;"></div>
  <div class="slides_d_next" style="cursor: pointer;"></div>
</div>
