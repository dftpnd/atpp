  ...
  <div class="wants">
    <div class="table_t">
      <div class="tr_t">
        <div class="td_t">
          <h2>Новости</h2>
          <div class="wants_rot aspx_4 active_poplavok" space="1" >
        ...
        <div class="td_t">
          <h2>Вопросы</h2>
          <div class="wants_rot aspx_7" space="2" >
        ...
        <div class="td_t">
          <h2>Коммуникация</h2>
          <div class="wants_rot aspx_9" space="3" >
        ...
        <div class="td_t">
          <h2>Cтатистика</h2>
          <div class="wants_rot aspx_5" space="4">
