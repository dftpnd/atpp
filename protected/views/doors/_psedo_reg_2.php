...
<div class="social">
  ...
  <a href="http://api.vkontakte.ru/oauth/authorize?client_id=3211710&amp;scope=&amp;redirect_uri=http://atpp.in/site/VkReg/&amp;response_type=code" class="enter_in_vk"></a>
</div>
  ...
  <div class="table_t reg_new">
    ...
    <div class='tr_t'>
      ...
      <div class='td_t'>
        ...
        <?php //echo CHtml::submitButton('Зарегистрироваться', array('class' => 'enter', 'id' => 'regbut')); ?>
