                ...
                <div class="table_t">
                    <div class="tr_t">
                        <div class="td_t">
                            ...
                            ?>
                            <?php echo CHtml::link("<img src='" . $img . "' />", Yii::app()->urlManager->createUrl('/user/ViewProfile', array('id' => $file->profile->id)), array('class' => 'classic')); ?> 
                            <?php echo CHtml::link($file->profile->name . " " . $file->profile->surname, Yii::app()->urlManager->createUrl('/user/ViewProfile', array('id' => $file->profile->id)), array('class' => 'classic')); ?> 
                        </div>
                        <div class="td_t">
