...
<div class="post">
  ...
  <div class="content">
    ...
    <?php
    if ($data->show_foto != 2) {
      echo CHtml::link('Посмотреть все фотографии', Yii::app()->urlManager->createUrl('post/scrapbook', array('post_id' => $data->id)), array('class' => 'scrap', 'id' => ''));
    }
    ?>
      ...
      <div class="tr_t">
        ...
        <div class="td_t">
          <div class="author">
            ...
            <?php echo CHtml::link($data->profile->name . ' ' . $data->profile->surname, Yii::app()->urlManager->createUrl('/user/ViewProfile', array('id' => $data->profile->id)), array('class' => 'classic', 'title' => 'Автор текста')); ?>
          </div>
        </div>
        <div class="td_t">
