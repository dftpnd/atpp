<div class="form">
    ...
    <div class="row">
        ...
        $this->widget('ImperaviRedactorWidget', array(
            ...
            'options' => array(
                ...
                'imageUpload' => '/post/ImperaviUpload'
            ),
        ));
    ...
    <div class="row selection">
        <div class="questions"
             title="Если вы написали пост на тему как то касающийся кафедры, не меняйте параметр, иначе переведите его в мировые"></div>
